<%-- 
    ...
    Created on : 27-Nov-2023, 10:13:51 am
    Author     : Sohan_Maali
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="com.commerce.other.Message"%>
<%@page import="com.commerce.model.EmployeeDao"%>

<%--<%@page errorPage="error_exception.jsp"%>--%>
<%
EmployeeDao activeEmployee = (EmployeeDao) session.getAttribute("activeEmployee");
            ...
            <div class="row">
                <div class="container text-center" id="details">
                    <img src="Images/admin.png" style="max-width: 180px;"
                         class="img-fluid">
                    <h3>
                        Welcome "<%=activeEmployee.getName()%>"
                    </h3>
                </div>
            </div>
            <div class="container">
                            ...
                            <div class="card text-bg-light mb-3 text-center">
                                <div class="card-body">
                                    <img src="Images/add-admin.png" style="max-width: 80px;"
                                         class="img-fluid">
                                    <h4 class="card-title mt-3">Employee</h4>
                                </div>
                            </div>
                        </a>
                    </div>
