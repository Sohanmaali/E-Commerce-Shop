...
public class ProductDao {
    ...
    public ProductDao(int productId, String productName, String productDescription, float productPrice,
    ...
    public ProductDao(String productName, String productDescription, float productPrice, int productDiscount,
    ...
    public ProductDao(int productId, String productName, float productPrice, int productDiscount, int productQunatity) {
        super();
        this.productId = productId;
        this.productName = productName;
        this.productPrice = productPrice;
