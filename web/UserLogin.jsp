<%-- 
    Document   : UserLogin
    Created on : 26-Nov-2023, 3:53:37 pm
    Author     : Sohan_Maali
--%>
...
<html>
    <head>
        <link rel="stylesheet" href="Components/common_css_js.jsp">
                ...
                <div class="col-md-4 offset-md-4">
                    <div class="card">
                        <div class="card-body px-5">
                            ...
                            <!--login-form-->
                            <form id="login-form" action="LoginControlar" method="post">
                            ...
                            <div class="mt-3 text-center">
                                ...
                                <h6>
                                    Don't have an account?<a href="UserRegistration.jsp"
