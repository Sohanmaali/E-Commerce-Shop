<%-- 
    Document   : cart
    Created on : 26-Nov-2023, 8:18:07 pm
    Author     : Sohan_Maali
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="com.commerce.model.UserDao"%>
<!DOCTYPE html>

<%
UserDao activeUser = (UserDao) session.getAttribute("activeUser");
%> 
<% 
    response.setHeader("Cache-Control", "No-Cache");
response.setHeader("Cache-Control", "No-Store");
//HttpSession session = (HttpSession)getAttribute("session");
